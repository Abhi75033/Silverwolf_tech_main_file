...
const AboutPage = () => (
  <Layout>
    <SEO
      title={`About Us | ${SITE.name} — 10+ Years of Digital Excellence`}
      ...
      keywords={["about silver wolf technologies", "best digital agency India", "experienced web development team"]}
    />
